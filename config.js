...
if (!(process.env.SESSION || process.env.SESSION_ID)) throw new Error("Raganork~0c4cfef0faa7028c99a474a8b046dbd6:74506477767a38765753513d")
module.exports = {
    VERSION: 'v4.0.0',
    ...
    SESSION: (process.env.SESSION || process.env.SESSION_ID || 'Raganork~98f359a134c4c4920b8a0c08c256dd7b:552b6a514777486b5476493d').trim() || '',
